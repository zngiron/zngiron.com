...
- **Ink residue:** the trail sheds small droplets (16–40px) from its tail every ~150–250ms while moving, and the idle retract breaks off 2–4 larger blots (28–64px) around the resting point. Droplets rise 80–160px over 4–6s with a sinusoidal sway (lava-lamp buoyancy) and dissolve by **scaling to 0** — never opacity fade, which snaps out through the goo filter's alpha threshold. Hard cap 12 concurrent droplets; they live inside the same goo/difference container so they inherit inversion, melt, and the hide states for free.
